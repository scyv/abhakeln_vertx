!(function(e) {
  if (false && "function" == typeof require && "undefined" != typeof module) {
    var n = require("sockjs-client");
    if (!n) throw new Error("vertx-eventbus.js requires sockjs-client, see http://sockjs.org");
    e(n);
  } else if ("function" == typeof define && define.amd) define("vertx-eventbus", ["sockjs"], e);
  else {
              ...
              (s.reconnectTimerID = setTimeout(
                ...
                (function() {
                  ...
                  if (s.randomizationFactor) {
                    var n = Math.random(),
                      t = Math.floor(n * s.randomizationFactor * e);
        ...
        (s.sockJSConn.onmessage = function(e) {
          ...
          if (
            ...
            for (var n = s.handlers[r.address], t = 0; t < n.length; t++)
              "err" === r.type ? n[t]({ failureCode: r.failureCode, failureType: r.failureType, message: r.message }) : n[t](null, r);
          else if (s.replyHandlers[r.address]) {
            var o = s.replyHandlers[r.address];
            delete s.replyHandlers[r.address], "err" === r.type ? o({ failureCode: r.failureCode, failureType: r.failureType, message: r.message }) : o(null, r);
  ...
  if (
    ...
    (a.prototype.publish = function(e, n, t) {
      if (this.state != a.OPEN) throw new Error("INVALID_STATE_ERR");
      this.sockJSConn.send(JSON.stringify({ type: "publish", address: e, headers: i(this.defaultHeaders, t), body: n }));
    }),
    (a.prototype.registerHandler = function(e, n, t) {
      if (this.state != a.OPEN) throw new Error("INVALID_STATE_ERR");
      "function" == typeof n && ((t = n), (n = {})),
        this.handlers[e] || ((this.handlers[e] = []), this.sockJSConn.send(JSON.stringify({ type: "register", address: e, headers: i(this.defaultHeaders, n) }))),
    ...
    (a.prototype.unregisterHandler = function(e, n, t) {
      ...
      if (r) {
        ...
        -1 != o &&
          (r.splice(o, 1),
          0 === r.length && (this.sockJSConn.send(JSON.stringify({ type: "unregister", address: e, headers: i(this.defaultHeaders, n) })), delete this.handlers[e]));
      }
    }),
